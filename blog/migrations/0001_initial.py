# Generated by Django 4.0.4 on 2022-06-20 11:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startdate', models.DateTimeField(default=datetime.datetime(2022, 6, 20, 20, 8, 6, 451656), verbose_name='노출 시작')),
                ('enddate', models.DateTimeField(default=datetime.datetime(2022, 6, 27, 20, 8, 6, 451656), verbose_name='노출 종료')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
